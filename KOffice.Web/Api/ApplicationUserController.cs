...
using KOffice.Common.Exceptions;
using KOffice.Model.Models;
using KOffice.Service;
using KOffice.Web.App_Start;
using KOffice.Web.Infrastructure.Core;
using KOffice.Web.Infrastructure.Extensions;
using KOffice.Web.Models;

namespace KOffice.Web.Api
{
    [Authorize]
