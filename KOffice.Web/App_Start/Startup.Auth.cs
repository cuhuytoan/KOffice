...
using KOffice.Common;
using KOffice.Data;
using KOffice.Model.Models;
using KOffice.Service;
using KOffice.Web.Infrastructure.Core;

[assembly: OwinStartup(typeof(KOffice.Web.App_Start.Startup))]
namespace KOffice.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(KOfficeDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<KOfficeDbContext>());
